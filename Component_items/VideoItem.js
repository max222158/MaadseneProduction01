...
export function VideoItem({item}) {
        ...
        return (
            <View>
            <View style={{  width: 150, marginLeft: 8 ,marginRight:5,backgroundColor: '#eef4f8',borderRadius:10 }}>
                <View style={{ flex: 2,width: 150,height:150,backgroundColor: '#eef4f8',borderRadius:10 }}>
                    
                    <ImageBackground source={{uri:item.image}} resizeMode="cover" imageStyle={{borderRadius:10}} style={{ flex: 1, width: null, height: '100%' }}>
