            ...
            <View style={{ width: widthWindow > 450 ? 400 : '80%', height: 500, backgroundColor: '#ffff', borderRadius: 10 }}>
                ...
                <ScrollView>
                    ...
                    <View style={{ flexDirection: "row", alignItems: "center", justifyContent: 'space-around', margin: 10 }}>
                        ...
                        <ButtonWithIconComponent colorText="black" textButton="Defaut" onPress={() => { webView.current.injectJavaScript(`document.getElementById('default_font').click();true`) }}
                        />
                        <ButtonWithIconComponent colorText="black" onPress={() => { webView.current.injectJavaScript(`document.getElementById('arial_font').click();true`) }}
                            textButton="Arial" />
